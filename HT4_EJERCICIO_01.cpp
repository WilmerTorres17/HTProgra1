...
void menu() {
	int opcion = 0;
	while (opcion != 3) {
		cout << "1 - Escribir o Ingresar Datos" << endl;
...
void escribir(){
	...
	ofstream archivo;
	archivo.open("HT4_EJERCICIO_01.txt", ios::app);
	...
	cout << "Ingrese Cantidad De Agricultores: "; cin >> n;
	...
	for (int i = 0; i < n; i++) {
		cout << "AGRICULTOR[" << i + 1 << "] Ingrese Que Tipo De Servicio Desea: "; cin >> tipo[i];
		cout << "AGRICULTOR[" << i + 1 << "] Ingrese El Numero De Hectareas: "; cin >> hecta[i];

		archivo << "AGRICULTOR[" << i + 1 << "]" << endl;
		...
		archivo << "Monto AGRICULTOR[" << i + 1 << "]:" << monto << endl;
		archivo << endl;
		...
		archivo << endl << endl;
		cout << "Monto AGRICULTOR[" << i + 1 << "]:" << monto << endl;
		cout << endl;
	}
}
void leer() {
	...
	archivo.open("HT4_EJERCICIO_01.txt", ios::in);
